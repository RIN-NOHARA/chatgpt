    ...
    <div className="review-section" id="reviews">
      <div className="rw-text-content">
        <p className="rw-text-title">
          More than <span className="rw-text-num">1500+ Conversations</span>
        </p>

        <p className="rw-text-desc">Don’t just take our word for it, see what users say about ChatGPT!</p>
